  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="relative w-full overflow-hidden" style={{ marginTop: 56, minHeight: 420 }}>
        ...
        {/* text block — responsive: 50% mobile, 38% desktop */}
        <div className="absolute inset-0 flex flex-col justify-start" style={{ minHeight: 420 }}>
          <div className="pt-6 pl-6 md:pl-12 lg:pl-20" style={{ width: "45%" }}>
            ...
            <BotanicalDivider />
            <p
              className="text-foreground/75 leading-relaxed mb-2"
          ...
          {hoursLines.map((h, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <div className="flex justify-between w-full">
                <span className="text-foreground" style={{ fontSize: "clamp(12px, 1.5vw, 15px)" }}>
                  {h.day}
                </span>
                <span className="text-foreground" style={{ fontSize: "clamp(12px, 1.5vw, 15px)" }}>
                  {h.time}
      ...
      <section className="relative w-full overflow-hidden mt-2" style={{ minHeight: 320 }}>
        ...
        />
        <div className="absolute inset-0" style={{
          background: "linear-gradient(to right, rgba(245,240,235,0.95) 0%, rgba(245,240,235,0.82) 30%, rgba(245,240,235,0.35) 52%, transparent 70%)"
        }} />
        <div className="absolute inset-0 flex flex-col justify-start" style={{ minHeight: 320 }}>
          <div className="pt-8 pl-6 md:pl-12 lg:pl-20" style={{ width: "45%" }}>
            <h2
              className="font-serif font-bold uppercase text-foreground leading-none mb-2"
              style={{ fontSize: "clamp(28px, 6vw, 58px)" }}
            >
